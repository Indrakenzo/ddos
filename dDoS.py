...
print()
print(colored("Author   : Indra Kenzo", 'grey'))
print(colored("Github   : https://github.com/Indrakenzo", 'grey'))
print(colored("Pertahanan terbaik adalah serangan!", 'grey'))
print(colored("alat ini ditulis untuk kepentingan pendidikan", 'grey'))
print(colored("Saya tidak bertanggung jawab atas kesalahan yang terjadi", 'red'))
print()
